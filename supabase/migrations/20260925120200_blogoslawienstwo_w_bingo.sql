-- ============================================================
-- Sekta Wyjazdowa — konsumpcja błogosławieństwa w akceptacji bingo
-- ============================================================
--
-- Funkcja jest przeniesiona w całości z 20260916140242_akceptacja_bingo.sql.
...
-- Powtórzone za poprzednią migracją, choć `create or replace` zachowuje
-- uprawnienia istniejącej funkcji i dziś są zbędne. Dwa powody: plik mówi wtedy
-- sam z siebie, kto może tę funkcję wywołać, a gdyby kiedykolwiek wykonał się na
-- bazie bez niej, `create` nadałby domyślny EXECUTE roli PUBLIC.
